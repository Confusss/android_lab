...
public class Main extends Base implements OnItemClickListener, OnItemLongClickListener {

    private nDatabase dbHelper;
            ...
            public void run() {
                ...
                lv_tag.setOnItemClickListener(new OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        ...
                        nAdapter tempAdapter = new nAdapter(context, temp);
                                            ...
                                            .setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
                                                ...
                                                public void onClick(DialogInterface dialog, int which) {
                                                    ...
                                                    for (int i = 0; i < noteList.size(); i++) {
                                                        ...
                                                        if (temp.getTag() == tag) {
                                                            temp.setTag(1);
                                                            manipulate op = new manipulate(context);
                                                            op.open();
                                                            op.updateNote(temp);
                                                            op.close();
                                                            //s
...
//        content_button = findViewById(R.id.content_button);
        ...
        adapter = new nAdapter(getApplicationContext(), noteList);
    ...
    public void initPopupView() {
        ...
        layoutInflater = (LayoutInflater) Main.this.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
                                    ...
                                    new AlertDialog.Builder(Main.this)
                                            ...
                                            .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                                                ...
                                                private void removeSelectItems(int which, int mode) {
                                                    ...
                                                    switch(mode){
                                                        case 1: //notes
                                                            dbHelper = new nDatabase(context);
                                                            SQLiteDatabase db = dbHelper.getWritableDatabase();
                                                            Cursor cursor = db.rawQuery("select * from notes" ,null);
                                                            while(cursor.moveToNext()){
                                                                if (cursor.getString(cursor.getColumnIndex(nDatabase.TIME)).compareTo(selectDateStr) < 0){
                                                                    db.delete("notes", nDatabase.ID + "=?", new String[]{Long.toString(cursor.getLong(cursor.getColumnIndex(nDatabase.ID)))});
                                                                }
                                                            }
